...
enum DictionaryKey: string implements DictionaryKeyInterface {
    ...
    public function getValueTypes(): array {
        return match ($this) {
            ...
            self::ANNOTS => [DictionaryArrayValue::class],
            ...
            self::CONTENTS => [TextStringValue::class],
            self::COORDS => [ArrayValue::class],
            self::COUNT => [IntegerValue::class],
            self::CP => [TextStringValue::class],
            self::CREATION_DATE => [DateValue::class, TextStringValue::class],
            ...
            self::DESCENDANT_FONTS => [Dictionary::class, DictionaryArrayValue::class],
            ...
            self::ENCODING => [EncodingNameValue::class, Dictionary::class, ExtendedDictionaryKey::class],
            ...
            self::FIELDS => [DictionaryArrayValue::class],
            ...
            self::TO_UNICODE => [ToUnicodeCMapNameValue::class],
            ...
            self::W => [CrossReferenceStreamByteSizes::class, CIDFontWidths::class, IntegerValue::class, FloatValue::class],
            ...
            self::ZA_DB => [TextStringValue::class],
